...
for parameters in adult compas crime german health lawschool; do
  ...
  python train_encoder.py --dataset ${dataset} --load \
    ...
    --constraint "GeneralCategorical(0, 0, ${categories})" \
    --dl2-weight 0
  ...
  # certify baseline
  python certify.py \
    --models-dir "../../models/${dataset}/GeneralCategorical(0, 0, ${categories})/${layers}/dl2_weight_0.0_learning_rate_0.001_weight_decay_0.01_balanced_False_patience_5_quantiles_False_dec_weight_0.0" \
    --num-certify 1000 --complete --epoch 99 --load

  # certify LCIFR
  python certify.py \
    --models-dir "../../models/${dataset}/GeneralCategorical(0, 0, ${categories})/${layers}/dl2_weight_${dl2_weight}_learning_rate_0.001_weight_decay_0.01_balanced_False_patience_5_quantiles_False_dec_weight_0.0" \
